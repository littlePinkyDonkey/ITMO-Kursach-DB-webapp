...
public class PlotProcessDTO {
    ...
    public PlotProcessDTO(int mainProcessId, int duration, Timestamp deadlineDate, String description, String processStatus, Timestamp startDate) {
